...
export const Header = () => {
  return (
    <header className="md:border-b md:p-4 py-4">
      <div className="container flex items-center justify-between">
        ...
        {/* search box*/}
        <div className="w-full md:w-fit flex justify-between md:justify-start gap-2 divide-x border px-4 py-2 rounded-full shadow-md hover:shadow-lg duration-200">
